...
```
./keyhunt -m address -f tests/btc.txt -r 0:fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141 -l compress -R -q -s 10 -t 4
```
...
```
```
./keyhunt -m address -f tests/35.txt -b 35 -l compress -R -q -s 10 -t 6
```
```
